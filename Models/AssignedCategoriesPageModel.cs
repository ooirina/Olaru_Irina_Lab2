...
namespace Olaru_Irina_Lab2.Models
{
    public class AssignedCategoriesPageModel:PageModel
    {

        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Olaru_Irina_Lab2Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Olaru_Irina_Lab2Context context,
